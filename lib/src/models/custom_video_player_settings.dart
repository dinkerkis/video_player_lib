import 'dart:ui';
import 'package:appinio_video_player/src/controls/fast_button.dart';
...
class CustomVideoPlayerSettings {
  ...
  /// Define the fast rewind button appearance.
  final Widget fastRewind;

  /// Define the fast forward button appearance.
  final Widget fastForward;
  ...
  /// If set to false no play/pause button will not be displayed.
  final bool showRewindForwardButtons;
  ...
  const CustomVideoPlayerSettings({
    ...
    this.fastRewind = const CustomVideoPlayerFastRewindButton(),
    this.fastForward = const CustomVideoPlayerFastForwardButton(),
    ...
    this.showRewindForwardButtons = true,
